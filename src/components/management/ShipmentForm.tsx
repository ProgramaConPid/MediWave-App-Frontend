            ...
            <div className="glass-strong p-8 rounded-2xl">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-foreground">Nuevo Envío</h3>
                            <p className="text-sm text-muted-foreground">Gestionar transporte</p>
                        </div>
                    </div>
                    <Button
                        variant="ghost"
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="ship-tracking" className="text-foreground flex items-center gap-2">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="ship-batch" className="text-foreground flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="ship-origin" className="text-foreground flex items-center gap-2">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="ship-destination" className="text-foreground flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="ship-date" className="text-foreground flex items-center gap-2">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="ship-carrier" className="text-foreground flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="ship-temp-set" className="text-foreground flex items-center gap-2">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="ship-priority" className="text-foreground flex items-center gap-2">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="ship-instructions" className="text-foreground flex items-center gap-2">
